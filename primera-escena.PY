...
Poligono(40,400,160,0,240,0,360,400,fill='gristurbio',borde='black')
Line(200,0,200,400,relleno='white',anchuraDeLinea=6,guión=(12,14))

##Daños##
Poligono(158,24,142,69,153,64,163,71,177,66,185,56,190,28,152,25,fill='white',borde='gris')
# Poligono(166,34,175,40,185,56,190,28,fill='gainsboro',opacity=100)
Poligono(263,88,277,138,259,132,244,141,244,121,213,116,217,97,239,98,263,88,fill='white',borde='gris')
Poligono(139,76,158,80,172,92,169,126,166,264,139,287,107,296,70,304,fill='azualaciano')
...
Line(298,127,288,127)
Oval(291,110,8,7,fill='oro',borde='black')
